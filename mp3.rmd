...
In the graph above, the taller bars from 2005 onwards indicate that sequels/remakes/reboots are more common in recent years than in the past. The number of follow-up films made each year show an overall pattern of increase. Yet note that the period from late 1920s to 1960 forms its own pattern. Historically, this period is usually coined as the [Golden Age of Hollywood](http://www.environmentalhistory.org/revcomm/cinema-clips/golden-age-of-hollywood/), during which thousands of star-studded movies were being produced by major Hollywood studios. The number of follow-up films sharply declines from the 1940s to 1960s, which aligns with the [“Fall of The Studio System”](http://tvtropes.org/pmwiki/pmwiki.php/UsefulNotes/FallOfTheStudioSystem) when Antitrust Laws forced major studios such as Paramount Pictures to reduce the overall number of movies they produced. From the 60s onwards, follow-up films have been on an steady upward trend, rationalized by studios having to [compete with television](https://www.theatlantic.com/entertainment/archive/2016/03/cycles-sequels-spinoffs-remakes-and-reboots/474411/) for their suburban family audiences. The past decade’s uptick in follow-up films can be explained by blockbusters such as *The Avengers*, which contain many sequels than can retain audience attention away from competing streaming services such as Netflix.  
...
sequelinter %>% ggplot(aes(x = sequel_year, y = interval)) + 
  ...
  theme_economist_white() + 
  scale_x_continuous(name = "Year of Follor-Up Film Production", 
                     breaks = c(1910, 1920, 1930, 1940, 1950, 1960, 
                                1970, 1980, 1990, 2000, 2010)) + 
